  ...
  <div class="col-lg-12">
	...
	<label>이미지${i}</label>
		<c:if test="${not empty games[t]}">
			<a href="/resources/upload/${games[t]}" target="_blank"><img src="/resources/upload/${games[t]}" id="thumb_${i}"></a>
			<script>
	        	document.getElementById('thumb_${i}').src="/resources/upload/" + getThumbFileName('${games[t]}');
			</script>
		</c:if>
