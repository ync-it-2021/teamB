    ...
    <section class="hero">
        <div class="container">
            <div class="hero__slider owl-carousel">
                <div class="hero__items set-bg" data-setbg="/resources/img/hero/hero-3.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <h2>이브 온라인</h2>
                                <div class="view" style="color:WHITE">
                                        나이트 헤이븐 업데이트 !
                                </div>
                                <a href="#"><span>무료로 플레이!</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <h2>발로란트</h2>
                                <div class="view" style="color:WHITE">
                                    시즌 2 에피소드 2 업데이트 기념 할인 !
                                </div>
                                <a href="#"><span><del>39,000 KRW</del>
                                    17,000 KRw</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
