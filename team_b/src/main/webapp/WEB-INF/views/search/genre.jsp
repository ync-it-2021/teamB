				...
				<div class="col-lg-12">
					<div class="breadcrumb__links">
						<a href="./index.html"><i class="fa fa-home"></i>홈</a> <a
							href="./categories.html">카테고리</a> <span>검색결과</span>
					</div>
				</div>
			</div>
		</div>
										...
										<c:if test="${not empty recent[t]}">
											<div class="product__sidebar__comment__item__pic">
												<a href='detail?game_num=<c:out value="${recent.game_num}"/>'>
													<img src="/resources/upload/${recent[t]}" alt="" width="90"
													height="130">
												</a>
											</div>
										</c:if>
